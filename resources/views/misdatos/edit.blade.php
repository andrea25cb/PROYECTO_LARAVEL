...
<div class="container mt-2">
    ...
    <div class="pull-left">
    <h2>Editing my user ( {{ $user->id }} )</h2>
    </div>
    <div class="pull-right">
    <a class="btn btn-primary" href="{{ route('misdatos.index') }}" enctype="multipart/form-data"> Back</a>
    </div>
    </div>
    </div>
        @if(session('status'))
        ...
        <div class="container mt-4">
            <form action="{{ route('misdatos.update',$user->id) }}" method="POST" enctype="multipart/form-data">
             @method('PUT')
